                  ...
                  currentPosts.map(
                    ({ COD, MASCOTA, HORARIO, FECHA, ESTADO, ACCIONES }, i) => (
                      <tr key={i}>
                        <td>{COD}</td>
                        <td>{MASCOTA}</td>
                        <td><div className="td-space">{HORARIO}</div></td>
                        <td><div className="td-space">{FECHA}</div></td>
                        <td>
                        ...
                        <Link to={`/dashboard/citas-view?status=${ESTADO}`} className="btn btn-sm btn-light btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">{ACCIONES}
                        </Link>
                      </td>
                      </tr>
                    )
